    ...
    >
      ...
      <div className="relative z-10 w-full h-full section-container py-32 pointer-events-none">
        ...
        <div className="mb-16 text-center">
          ...
          <h2 className="font-display font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-ink tracking-tighter">
            Hidden Vault.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
          {CERTIFICATIONS.map((cert, i) => (
            <div 
              ...
              className={`relative border p-10 backdrop-blur-sm pointer-events-auto cursor-pointer transition-transform hover:scale-[1.02] ${
                isLightMode 
                  ? "border-black/10 bg-white hover:bg-white/90" 
                  : "border-white/10 bg-black hover:bg-black/90"
              } lg:mt-16`}
            >
              ...
              <span className={`font-mono text-[10px] tracking-widest uppercase block mb-8 ${
                isLightMode ? "text-[#c08000]" : "text-signal"
              }`}>
                SYS.ID // {cert.id}
              </span>
              ...
              <p className={`font-sans text-sm uppercase tracking-widest ${
                ...
                Issued by: <span className={`font-bold ${
                  isLightMode ? "text-black" : "text-white"
                }`}>{cert.org}</span>
              </p>
